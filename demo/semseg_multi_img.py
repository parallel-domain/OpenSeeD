...
from utils.arguments import load_opt_ray
...
def main(args=None):
    ...
    '''
    opt = load_opt_ray(args)
    
    if args["user_dir"]:
        absolute_user_dir = os.path.abspath(args.user_dir)
    ...
    with torch.no_grad():
        for image_file in image_files:
            ...
            anypath = AnyPath(image_file)
            width = image_ori.size[0]
            height = image_ori.size[1]
            image = transform(image_ori)
            np_image = pd.fsio.read_image(AnyPath(image_file))
            ...
            # semseg.shape = [H,W] values are class IDs
...
if __name__ == "__main__":
    args = {
        "command":'evaluate', 
        "conf_files":['/home/michael/pd/OpenSeeD/configs/openseed/openseed_swint_lang.yaml'], 
        "config_overrides":None, 
        "image_path":'/home/michael/pd/OpenSeeD/images/animals.png', 
        "overrides":['WEIGHT', '/home/michael/model_checkpoints/OpenSeeD/model_state_dict_swint_51.2ap.pt'], 
        "user_dir":None
        }
